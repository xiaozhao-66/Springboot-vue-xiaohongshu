...
// import ZIM from '@/js_sdk/zego-ZIMUniPlugin-JS/lib';
import { getZimToken } from '@/api/chat.js'
	...
	methods: {
		...
		createws() {
			...
			getZimToken(params).then(response => {
				...
				var userInfo = { userID: that.userInfo.id, userName: that.userInfo.username };
		...
		send() {
			...
			var messageTextObj = { type: 1, message: that.recordInput, extendedData: '1' };
			var notification = {
