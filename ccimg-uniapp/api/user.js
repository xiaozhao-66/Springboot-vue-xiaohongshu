...
export function getUserRecord (params) {
  return request.get(appConfig.WEB_API + `/platform/userrecord/getUserRecord`, params)  
}

export function clearUserRecord (params) {
  return request.get(appConfig.WEB_API + `/platform/userrecord/clearUserRecord`, params)  
}