...
package com.xz.admin.common.aspect;
...
import com.xz.admin.modules.log.enums.OperationStatusEnum;
...
public class LogOperationAspect {
    ...
    @Pointcut("@annotation(com.xz.admin.common.annotation.LogOperation)")
